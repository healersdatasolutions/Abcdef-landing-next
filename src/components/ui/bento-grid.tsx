...
export const BentoGridItem2 = ({
  ...
  return (
    <div
      className={cn(
        "h-[22rem] sm:h-auto rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none  dark:bg-black  justify-end flex  flex-col ",
        className
      )}
    >
