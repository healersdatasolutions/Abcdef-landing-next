...
const Footer = () => {
  return (
    <>
      <div className=" flex items-center bg-gradient-to-b from-transparent to-black justify-center translate-y-14">
      <TextHoverEffect text="HEALERS HEALTHCARE" />
    </div>
      <footer className="relative z-10 bg-black pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] rounded-lg">
