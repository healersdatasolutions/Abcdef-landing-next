      ...
      {/* {showDeletionForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg max-w-md w-full">
            ...
            <p className="mb-4">Please contact us at jainbhomik@gmail.com or sahilshandil2@gmail.com to request account deletion.</p>
            <Button onClick={() => setShowDeletionForm(false)}>Close</Button>
          </div>
        </div>
      )} */}
    </div>
